...
net.load_state_dict(torch.load('licence_system/models/checkpoints/LPLocalNet_B250_E500_LR0.0010_Acc74.22.pth', map_location='cpu'))
net.eval()
...
with Image.open(selected_img).convert('L') as img:
	...
	with torch.no_grad():
		...
		demo_arr.append(["Image #{}".format(0), X.to('cpu').view(-1, 1, 416, 416), (0, 0, 0, 0), predicted_bbox])
